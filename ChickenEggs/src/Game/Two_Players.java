...
public class Two_Players extends Anim_Listener {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (isKeyPressed(KeyEvent.VK_SPACE)) {
            ...
            } else if (isKeyPressed(KeyEvent.VK_RIGHT) && left.getXBasket() < newMaxWidth - 13) {
                left.setXBasket(left.getXBasket() + left.getLevel());
            }
            ...
            if (isKeyPressed(KeyEvent.VK_A) && right.getXBasket() > 53) {
                right.setXBasket(right.getXBasket() - right.getLevel());
            } else if (isKeyPressed(KeyEvent.VK_D) && right.getXBasket() < 2 * newMaxWidth - 13) {
                right.setXBasket(right.getXBasket() + right.getLevel());
            }
